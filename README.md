...
Все дальнейшие действия были проверены в VirtualBox 7.1.4, на которой развернут Ubuntu Server 24.04.3 и клиентской машине с Ubuntu 24.04.1 Desktop.
...
5. Выберите последнюю стабтльную версию ядра, которая соответствует вашей архитектуре. На момент составления документа нам подходит версия 6.17: https://kernel.ubuntu.com/mainline/v6.17/.
...
11. Перезагурзите виртуальную машину с помощью команды:
